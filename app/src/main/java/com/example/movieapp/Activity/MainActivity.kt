        ...
        floatingActionButton = {
            Box(
                ...
                FloatingActionButton(
                    ...
                    content = {
                        Icon(
                            painterResource(R.drawable.float_icon),
...
floatingActionButtonPosition = androidx.compose.material.FabPosition.Center,
        ...
        Box(
            ...
            Image(
                ...
                modifier = Modifier.fillMaxSize() // Use fillMaxSize instead of matchParentSize
            )
...
fun MainContent(onItemClick: (FilmItemModel) -> Unit) {
    ...
    var showUpComingLoad by remember { mutableStateOf(value = true) }
    var showNewMoviesLoading by remember { mutableStateOf(value = true) }

    LaunchedEffect (Unit){
        viewModel.loadUpcoming().observeForever{
            Log.d("MainContent", "Received ${newMovies.size} upcoming movies")
